...
- Ucretsiz Twitter API provider (1. sira): `lib/providers/twitter-free-api.ts`
- Twitter API provider (2. sira): `lib/providers/twitter-api.ts`
- Ortak piyasa degeri ve TL/USD/EUR formatlayici: `lib/football/market-value.ts`
- Oyuncu detay istatistik/rating/mac uretici: `lib/football/player-stats.ts`
